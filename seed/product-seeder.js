...
const products = [
  new Product({
    ...
    description:
      'Together with all the new features included in Pes 2016, the Soccer Series will feature the Dynamic Weather System for the first time. This new implementation will not only graphically improve the effects of time in the game, but will also affect the gameplay itself, playing an important role in the redesign of the Master League mode and in offline games. New Celebration Features. Title: Pes 16 Platform: Ps4 Production company: Konami Characteristics: Genre: Sport Age group: Free Players: 1-4 Offline / 2-22 Online Language Game: Audio In Portuguese-Br With Narration by Mauro Beting And Silvio Luis Language Manual: Portuguese Sac: 4003-7669 For Capitals and Metropolitan Regions 0800-880-7669 Other Locations. Not all features are available for all gaming platforms.',
    price: 269
  }),
  new Product({
    imagePath:
